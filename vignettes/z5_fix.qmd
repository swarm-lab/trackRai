---
title: "5. Fixing tracks"
author: "Simon Garnier"
vignette: >
  %\VignetteIndexEntry{5. Fixing tracks}
...
![](images/z5_1.jpg){style="border-radius: 5px; border-style: groove;" fig-align="center"}
...
Once you click the “Save” button in the app, the data that is saved in the “\[original_file_name\]\_fixed.csv” file has the same columns has those saved originally by the tracking app (see [here for more details](z4_track.html#output)).
