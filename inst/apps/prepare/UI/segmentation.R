disabled(
  verticalTabPanel(
    ...
    tags$table(
      tags$tr(
        tags$td(
          actionButton("optimizeThresholds_x", "Autothreshold", width = "100%"),
          style = "width: 39%; padding-top: 4px"
        ),
        tags$td(HTML("&nbsp;with&nbsp;")),
        tags$td(
          selectInput("thresholdMethod_x", "", c(
            "Otsu's method" = "Otsu",
    ...
    hr(class = "hr-text", `data-content` = "Or manual threshold"),
    # sliderInput("redThreshold_x", "RGB thresholds",
    #   width = "100%", min = 1, max = 255,
    #   value = 30, step = 1
    # ),
    # sliderInput("greenThreshold_x", NULL,
    #   width = "100%", min = 1, max = 255,
    #   value = 30, step = 1
    # ),
    # sliderInput("blueThreshold_x", NULL,
    #   width = "100%", min = 1, max = 255,
    #   value = 30, step = 1
    # ),
    sliderInput("threshold_x", NULL,
      width = "100%", min = 1, max = 255,
      value = 30, step = 1
    ),
    hr(),
